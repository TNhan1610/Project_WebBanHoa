...
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    <div class="form-inline">
        ...
        Giá đến <asp:TextBox ID="txtGiaDen" runat="server" CssClass="form-control"></asp:TextBox>
        <asp:Button ID="btnTraCuu" runat="server" Text="Tra Cứu" CssClass="btn btn-info" OnClick="btTraCuu_Click" />
    </div>

     <div class="row">
        <asp:Repeater ID="rpHoa" runat="server">
            <ItemTemplate>
